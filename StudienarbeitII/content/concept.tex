...
aus \cite{grubenMerkeBabics:2012}
\begin{itemize}
  \item Ranking by\begin{itemize}
    \item score
    \item time invested
    \item stars
    \item coins
  ...
  \item class room
  \item für newbie\begin{itemize}
    \item Quick-Start Guide (Video-)Instruction, (Video-)Tutorial
    \item Simple and practical exercises
    ...
    \item Progress bar
  \end{itemize}
  \item für regular\begin{itemize}
    \item Rise to Proficiency or Expert (additional to a Tutor)
    \item Stars for recognition regarding to assistence
    \item Collections of Achievements according to the current progression
    \item Difficulty of exercises depending on the level
    \item Progress bar
    \item Statistical evaluation (Ranking)
  \end{itemize}
  \item für Enthusiast\begin{itemize}
    \item Rise to Mastery level (alternative)
    \item Levels
...
aus \cite{grubenMerkeBabics:2012}
\begin{itemize}
  \item intrinsic\begin{itemize}
    \item Getting higher level on Dreyfuss-Model
    \item Feedback from Support as a tutor
    \item Training long-term-memory by teaching stuff as a tutor
    \item Getting deeper into topic specific knowledge
  \end{itemize}
  \item extrinsic\begin{itemize}
    \item Getting rewards
    \item changing\begin{itemize}
      \item Design
      \item Avatar
      \item Tamagochi\end{itemize}
  \item Highscore for comparing the score with other fellows
  \item Good evaluation in personal real life
  \item Personal statistic overall analysis
  \end{itemize}
\end{itemize}
\end{k}

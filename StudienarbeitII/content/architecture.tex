...
\end{itemize}
Die Suche von WBTs wird �ber reine SQL-Abfragen realisiert. 
Dies bedeutet, dass bei einem Aufruf der WBT-Liste, die Daten des betreffenden Users ausgelesen werden. 
Entsprechend des Levels eines Users im betreffenden Themengebiet werden die Daf�r 
...
ein Suchkriterium. Jedes WBT ist Teil mindestens eines Themengebietes. Au�erdem
sind die R�nge an die Themen gebunden. Der Benutzer kann WBTs in jedem
...
Newbie ist. Ist ein WBTs zwei (oder mehr) Themen zugeordnet, so erh�lt der Benutzer bei Abschluss die 
Punkte f�r beide Themengebiete.
Themen k�nen Unterthemen haben, daher kann ein Benutzer innerhalb eines �berthemas unterschiedliche R�nge haben. 
So kann z.B. ein Benutzer im Thema Informatik ein Expertise sein und zugleich in den 
Unterthemen Datenstrukturen und Algorithmen Specialist bzw. Newbie sein.
...
Das hier Beschriebene ist der Stand der Alpha-Version. Eine m�gliche �nderung f�r die Zukunft w�re, 
dass erreichte Punkte eines Unterthemas auch im �berthema gutgeschrieben werden. 
\end{k}
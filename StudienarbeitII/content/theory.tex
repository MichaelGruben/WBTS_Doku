...
SCORM ist demach das Schaffen einer Ebene zwischen einem WBT und einem LMS.
Beide kommunizieren über eine standardisierte Schnittstelle, der SCORM-API,
miteinander.

\ac{API}

Abbildung \ref{pic:scormApi} zeigt die Anbindung der SCORM-API an das LMS und
WBT.
